                ...
                <form onSubmit={handleCreateDeck} className="relative rounded-md">
                    ...
                    <div className="p-4 md:p-5 space-y-4">
                        ...
                        <div>
                            ...
                            <input onChange={event => setDesc(event.target.value)} value={decs} id="decs-deck" type="text" required className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" />
                        </div>
