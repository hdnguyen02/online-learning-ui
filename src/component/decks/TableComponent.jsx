...
function GlobalFilter ({ globalFilter, setGlobalFilter, getDecks }) {
    ...
    <ModalCreateDeck getDecks={getDecks} ref={refModalCreateDeck}></ModalCreateDeck>
  </div>
} 

const TableComponent = ({ columns, data, handleEdit, handleDelete, handleStudy, getDecks }) => {
  const {
    getTableProps,
    getTableBodyProps,
    headerGroups,
