        ...
        <div className="mt-8     font-medium">
            <div>
                ...
                <div style={{ fontWeight: "400" }} className="mt-6 flex gap-x-5 text-sm">
                    ...
                    <Link to={`/groups/common-decks/${params.id}/learn-cards/flip`} className="bg-[#F6F7FB] dark:bg-[#2E3856] py-6 px-16 flex items-center flex-col gap-y-2 rounded-lg cursor-pointer">
