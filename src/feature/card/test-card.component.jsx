    ...
    return <div className="bg-[#0A092D]">
...

        {
            (isStart || isEnd) && <div className="fixed top-28 left-8">
                ...
                {isOpenOverviewQuestions && <i onClick={onCloseOverviewQuestions} className="fa-solid fa-xmark text-2xl cursor-pointer text-white"></i>}
                {
        ...
        >
            <div className="w-full h-full bg-[#0A092D] px-10 py-12">
                ...
                <div className="flex flex-col gap-y-4 items-center">
                    <span className="font-bold text-3xl text-white">Có vẻ như bạn đã bỏ qua một số câu hỏi</span>
                    <span className="text-lg text-white">Bạn muốn xem lại các câu hỏi đã bỏ qua hay gửi bài kiểm tra ngay bây giờ?</span>
