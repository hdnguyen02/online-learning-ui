        ...
        <div className="mt-8 font-medium">
            <div>
                ...
                <div style={{ fontWeight: "400" }} className="mt-6 flex gap-x-5 text-sm">
                    <Link to={`/my-decks/${params.id}/learn-cards/join`} className="bg-[#F6F7FB] dark:bg-[#2E3856] py-6 px-16 flex items-center flex-col gap-y-2 rounded-lg cursor-pointer">
                    
                    <i className="fa-solid fa-layer-group  text-[#4255FF] text-3xl"></i>
                        <span className="text-gray-800 font-medium">Ghép thẻ</span>
                    </Link>

                    <Link to={`/my-decks/${params.id}/learn-cards/test`} className="bg-[#F6F7FB] dark:bg-[#2E3856] py-6 px-16 flex items-center flex-col gap-y-2 rounded-lg cursor-pointer">
