...
function Home() {
    return (
        <div className="mt-[60px] w-full">
            ...
            <img className="w-full" src="https://cdn.pixabay.com/photo/2016/02/16/21/07/books-1204029_1280.jpg" loading="lazy" alt="" />
            <div className="mt-12 flex gap-x-12 px-48 'mb-[270px]">
            ...
            <footer class="mt-12 bg-white dark:bg-gray-900 px-48">
