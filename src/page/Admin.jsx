...
export default function SettingComponent() {
    ...
    return <div className="w-full h-full">
        <dh-component>
            ...
            <div className="w-64 fixed top-0 left-0 h-screen bg-gray-800 shadow flex flex-col justify-between">
                    <div className="px-8">
                        <div className="h-16 w-full flex items-center">
                            ...
                            <span className="text-orange-500 text-2xl font-bold">Online learning</span>
                        </div>
                        <ul className="mt-12">
                            <Link to={"/admin"} className="flex w-full justify-between text-gray-300 cursor-pointer items-center mb-6">
                            ...
                            <Link to={"/admin/statistics"} className="flex w-full justify-between text-gray-300 cursor-pointer items-center mb-6">
                                <span className="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                                    <i class="mb-0.5 fa-solid fa-chart-simple"></i>
                                    <span className="text-sm ml-2">Statistics</span>
                                </span>
                                {/* <div className="py-1 px-3 bg-gray-600 rounded text-gray-300 flex items-center justify-center text-xs">6</div> */}
                            </Link>
                            ...
                            <li className="flex w-full justify-between text-gray-300 cursor-pointer items-center mb-6">
                                ...
                                <i class="mb-0.5 fa-solid fa-house"></i>
